...
(let ((background "#303446")
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((t (:background "#f2d5cf"))))
   `(fringe ((t (:background ,background))))
   `(region ((t (:background "#626880"))))
   ...
   `(line-number ((t (:foreground "#626880" :background ,background))))
   ...
   `(mode-line-inactive ((t (:foreground "#b5bfe2" :background ,surface-dark :box (:line-width -1 :color ,border)))))
