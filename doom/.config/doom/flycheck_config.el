...
(after! org
  (setq org-archive-location
        ...
        `(("t" "Task" entry
           ...
           "* TODO %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n")
          ("n" "Note" entry
           (file+headline ,(expand-file-name "notes.org" org-directory)
                          "Inbox")
           "* %?\n:PROPERTIES:\n:CREATED: %U\n:END:\n")
          ("m" "Meeting" entry
           (file+olp ,(expand-file-name "projects.org" org-directory)
                     "Meetings")
           "* %? :meeting:\nSCHEDULED: %^t\n:PROPERTIES:\n:CREATED: %U\n:END:\n")
          ("T" "Tickler" entry
           (file+headline ,(expand-file-name "tickler.org" org-directory)
                          "Tickler")
           "* TODO %?\nSCHEDULED: %^t\n:PROPERTIES:\n:CREATED: %U\n:END:\n")
          ("j" "Journal" entry
  ...
  (setq org-roam-directory
        ...
        '(("n" "Note" plain "%?"
           :target (file+head "%<%Y%m%d%H%M%S>-${slug}.org"
                              "#+title: ${title}\n\n")
           :unnarrowed t)
          ("d" "Documentation" plain "%?"
           :target (file+head "docs/%<%Y%m%d%H%M%S>-${slug}.org"
                              "#+title: ${title}\n#+filetags: :docs:\n\n")
           :unnarrowed t))
